...
public class CgenConfiguration implements XMLSerializable {
    ...
    public void encodeAsXML(XMLEncoder encoder, ConfigurationNodeVisitor delegate) {
        encoder.start("config")
                ...
                .simpleTag("additionalMaps", (additionalMaps != null) ? additionalMaps.getAbsolutePath() : null)
                .simpleTag("client", Boolean.toString(client))
                .simpleTag("destDir", (destDir != null) ? destDir.getAbsolutePath() : null)
                .simpleTag("embeddableTemplate", embeddableTemplate)
                .simpleTag("embeddableSuperTemplate", embeddableSuperTemplate)
                .simpleTag("encoding", encoding)
                .simpleTag("excludeEntities", excludeEntities)
                .simpleTag("includeEntities", includeEntities)
                .simpleTag("makePairs", Boolean.toString(makePairs))
                .simpleTag("mode", artifactsGenerationMode.getLabel())
                .simpleTag("overwrite", Boolean.toString(overwrite))
                .simpleTag("superPkg", superPkg)
                .simpleTag("superTemplate", superTemplate)
                .simpleTag("template", template)
                .simpleTag("usePkgPath", Boolean.toString(usePkgPath))
                .simpleTag("createPropertyNames", Boolean.toString(createPropertyNames))
                .simpleTag("outputPattern", outputPattern)
                .end();
    }
}
